...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_STATUS = new FinderPath(StudentModelImpl.ENTITY_CACHE_ENABLED,
			StudentModelImpl.FINDER_CACHE_ENABLED, StudentImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_STATUS =
		new FinderPath(StudentModelImpl.ENTITY_CACHE_ENABLED,
			...
			StudentModelImpl.STATUS_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_STATUS = new FinderPath(StudentModelImpl.ENTITY_CACHE_ENABLED,
			StudentModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Student> findBystatus(int status, int start, int end) {
	...
	public Student findBystatus_First(int status,
		OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {
		Student student = fetchBystatus_First(status, orderByComparator);
	...
	public Student fetchBystatus_First(int status,
		OrderByComparator<Student> orderByComparator) {
		List<Student> list = findBystatus(status, 0, 1, orderByComparator);
	...
	public Student findBystatus_Last(int status,
		OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {
		Student student = fetchBystatus_Last(status, orderByComparator);
	...
	public Student fetchBystatus_Last(int status,
		...
		List<Student> list = findBystatus(status, count - 1, count,
				orderByComparator);
	...
	public Student[] findBystatus_PrevAndNext(long studentId, int status,
		...
		try {
			...
			array[0] = getBystatus_PrevAndNext(session, student, status,
					orderByComparator, true);

			array[1] = student;

			array[2] = getBystatus_PrevAndNext(session, student, status,
					orderByComparator, false);
	...
	protected Student getBystatus_PrevAndNext(Session session, Student student,
	...
	public void removeBystatus(int status) {
		for (Student student : findBystatus(status, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(student);
		}
	}
	...
	private static final String _FINDER_COLUMN_STATUS_STATUS_2 = "student.status = ?";
	...
	public Student updateImpl(Student student) {
		...
		if (isNew || !StudentModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((studentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						studentModelImpl.getOriginalStatus()
					};
				...
				args = new Object[] { studentModelImpl.getStatus() };
