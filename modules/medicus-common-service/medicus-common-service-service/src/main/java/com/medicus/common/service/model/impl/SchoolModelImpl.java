...
import com.medicus.common.service.model.SchoolModel;
...
/**
 * The base model implementation for the School service. Represents a row in the &quot;Medicus_School&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link SchoolModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link SchoolImpl}.
 * </p>
 *
 * @author sandip.patel
 * @see SchoolImpl
...
public class SchoolModelImpl extends BaseModelImpl<School>
	 ...
	 */
	public static final String TABLE_NAME = "Medicus_School";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.medicus.common.service.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.medicus.common.service.model.School"),
			true);
	...
	public Object clone() {
		...
		schoolImpl.setZipcode(getZipcode());
		schoolImpl.setContactNumber(getContactNumber());
		schoolImpl.setWebsiteLink(getWebsiteLink());
		schoolImpl.setContactPersonName(getContactPersonName());
		schoolImpl.setContactPersonPhoneNumber(getContactPersonPhoneNumber());
		schoolImpl.setContactPersonEmail(getContactPersonEmail());
		...
		schoolImpl.setModifiedBy(getModifiedBy());
	...
	public int compareTo(School school) {
		...
		value = DateUtil.compareTo(getCreateDate(), school.getCreateDate());
	...
	public CacheModel<School> toCacheModel() {
		...
		schoolCacheModel.address1 = getAddress1();

		String address1 = schoolCacheModel.address1;
		...
		schoolCacheModel.country = getCountry();

		String country = schoolCacheModel.country;

		if ((country != null) && (country.length() == 0)) {
			schoolCacheModel.country = null;
		}

		schoolCacheModel.zipcode = getZipcode();

		String zipcode = schoolCacheModel.zipcode;

		if ((zipcode != null) && (zipcode.length() == 0)) {
			schoolCacheModel.zipcode = null;
		}

		schoolCacheModel.contactNumber = getContactNumber();

		String contactNumber = schoolCacheModel.contactNumber;

		if ((contactNumber != null) && (contactNumber.length() == 0)) {
			schoolCacheModel.contactNumber = null;
		}

		schoolCacheModel.websiteLink = getWebsiteLink();

		String websiteLink = schoolCacheModel.websiteLink;

		if ((websiteLink != null) && (websiteLink.length() == 0)) {
			schoolCacheModel.websiteLink = null;
		}

		schoolCacheModel.contactPersonName = getContactPersonName();

		String contactPersonName = schoolCacheModel.contactPersonName;

		if ((contactPersonName != null) && (contactPersonName.length() == 0)) {
			schoolCacheModel.contactPersonName = null;
		}

		schoolCacheModel.contactPersonPhoneNumber = getContactPersonPhoneNumber();

		String contactPersonPhoneNumber = schoolCacheModel.contactPersonPhoneNumber;

		if ((contactPersonPhoneNumber != null) &&
				(contactPersonPhoneNumber.length() == 0)) {
			schoolCacheModel.contactPersonPhoneNumber = null;
		}

		schoolCacheModel.contactPersonEmail = getContactPersonEmail();

		String contactPersonEmail = schoolCacheModel.contactPersonEmail;

		if ((contactPersonEmail != null) && (contactPersonEmail.length() == 0)) {
			schoolCacheModel.contactPersonEmail = null;
		}
		...
		schoolCacheModel.modifiedBy = getModifiedBy();
	...
	private static final ClassLoader _classLoader = School.class.getClassLoader();
