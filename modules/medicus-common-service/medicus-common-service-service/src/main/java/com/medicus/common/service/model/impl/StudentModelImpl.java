...
public class StudentModelImpl extends BaseModelImpl<Student>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ethnicityDesc", Types.VARCHAR);
	...
	public static final String TABLE_SQL_CREATE = "create table Medicus_Student (uuid_ VARCHAR(75) null,studentId LONG not null primary key,companyId LONG,stundetCampusId VARCHAR(75) null,campusId LONG,schoolId LONG,firstName VARCHAR(75) null,middleName VARCHAR(75) null,lastName VARCHAR(75) null,profileImageId LONG,dateOfBirth DATE null,gender VARCHAR(75) null,contactNumber VARCHAR(75) null,homePhoneNumber VARCHAR(75) null,emailAddress VARCHAR(75) null,primaryLanguage VARCHAR(75) null,secondaryLanguage VARCHAR(75) null,address VARCHAR(75) null,city VARCHAR(75) null,zipcode VARCHAR(75) null,state_ VARCHAR(75) null,pace VARCHAR(75) null,ethnicityDesc VARCHAR(75) null,gpa DOUBLE,resumeFileEntryId LONG,profession VARCHAR(75) null,practices VARCHAR(75) null,hired BOOLEAN,graduationDate DATE null,activelySeekingEmployment BOOLEAN,haveExternship BOOLEAN,status INTEGER,createDate DATE null,createdBy LONG,modifiedDate DATE null,modifiedBy LONG)";
	...
	public Object clone() {
		...
		studentImpl.setEthnicityDesc(getEthnicityDesc());
	...
	public CacheModel<Student> toCacheModel() {
		...
		studentCacheModel.ethnicityDesc = getEthnicityDesc();

		String ethnicityDesc = studentCacheModel.ethnicityDesc;

		if ((ethnicityDesc != null) && (ethnicityDesc.length() == 0)) {
			studentCacheModel.ethnicityDesc = null;
		}
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>ethnicityDesc</column-name><column-value><![CDATA[");
		sb.append(getEthnicityDesc());
		sb.append("]]></column-value></column>");
		sb.append(
