...
public class CampusLocalServiceUtil {
	...
	*/
	...
	public static com.medicus.common.service.model.Campus addCampus(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .addCampus(schoolId, name, address1, address2, city, state,
			country, campusContactNumber, websiteLink, contactPersonName,
	...
	*/
	...
	public static com.medicus.common.service.model.Campus upateCampus(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .upateCampus(campusId, schoolId, name, address1, address2,
			city, state, country, campusContactNumber, websiteLink,
