...
/**
 * Provides the local service interface for Interview_Request. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author sandip.patel
 * @see Interview_RequestLocalServiceUtil
...
public interface Interview_RequestLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Interview_RequestLocalServiceUtil} to access the interview_ request local service. Add custom service methods to {@link com.medicus.common.service.service.impl.Interview_RequestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Interview_Request addInterviewRequest(long partnerId,
		long studentId, int status, long createdBy)
		throws PortalException, IOException, AddressException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Interview_Request> getInterviewReqeustsByPartnerId(
		long partnerId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Interview_Request> getInterviewRequestsByStudentId(
		long studentId);
